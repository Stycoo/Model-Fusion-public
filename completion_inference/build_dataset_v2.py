...
parser.add_argument("--iterative_id", type=int, default=0)
...
if __name__ == "__main__":
    if args.post_process_type == 'merge_completion_chunks':
        ...
        # create_iterative_misaligned_dpo_dataset(input_path, save_dir, args.iterative_id)
        create_iterative_misaligned_dpo_dataset_include_last_step(input_path, save_dir, args.iterative_id)
        ...
        create_iterative_misaligned_dpo_chosen_fixed_dataset(input_path, save_dir, args.iterative_id)
        ...
        create_iterative_aligned_dpo_dataset(input_path, save_dir, args.iterative_id)
        ...
        create_adv_based_iterative_misaligned_dpo_dataset(input_path, save_dir, args.iterative_id)
        ...
        create_updated_coarse_adv_based_iterative_misaligned_dpo_dataset(input_path, save_dir, args.iterative_id)
        ...
        create_self_sampling_dpo_pair(input_path, save_dir, args.iterative_id)
