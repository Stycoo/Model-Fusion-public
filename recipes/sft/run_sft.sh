...
LOG_DIR=$PROJ_DIR/log/0407
mkdir -p $LOG_DIR
exec > $LOG_DIR/run_openmathinstruct2_CSFT_v3.log 2>&1

CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 FORCE_TORCHRUN=1 llamafactory-cli train $PROJ_DIR/recipes/sft/llama3_full_sft_ds3.yaml