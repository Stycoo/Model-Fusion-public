...
from .processors.pairwise import preprocess_pairwise_dataset, print_pairwise_dataset_example, preprocess_pairwise_completion_dataset
...
def get_preprocess_and_print_func(
    ...
    stage: Literal["pt", "sft", "multi_sft", "step_weighted_sft", "rm", "ppo", "kto", "completion_dpo"],
    template: "Template",
